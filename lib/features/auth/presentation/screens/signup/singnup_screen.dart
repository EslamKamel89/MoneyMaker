                ...
                child: Column(
                  children: [
                    ...
                    AuthTextField(
                      ...
                      controller: controller.signUpFullNameEngCont,
                      validator: (value) {
                    ...
                    AuthButton(
                      ...
                      onTap: () {
                        if (formKey.currentState!.validate() &&
                          ...
                          Navigator.of(context).pushNamed(AppRoutesNames.pickVerificationMethodSignup);
                        }
                        ...
                        if (!controller.isUploadPassport && controller.uploadIdDocumentFileTwo == null) {
                          customSnackBar(
                              context: context, title: "UPLOAD_TWO_PHOTO".tr(context), backgroundColor: Colors.red);
                        }
                      },
                    ),
